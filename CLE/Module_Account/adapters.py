...
class SocialAccountWhitelist(DefaultSocialAccountAdapter):
    ...
    def pre_social_login(self, request, sociallogin):
        ...
        if isInstructor != [] or sociallogin.account.extra_data["email"] in ("keagenkoi@gmail.com","rafaelbarros@smu.edu.sg","wendytanlc@smu.edu.sg","paulgriffin@smu.edu.sg","michellekan@smu.edu.sg","albertkeagen@gmail.com"):
