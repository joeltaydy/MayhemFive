# Generated by Django 2.0.7 on 2018-08-09 07:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_description', models.CharField(db_column='Course_Description', max_length=255, null=True)),
            ],
            options={
                'db_table': 'Course',
                'managed': True,
        ...
        migrations.AddField(
            model_name='class',
            name='clt_id',
            field=models.ForeignKey(db_column='CLT_ID', on_delete=django.db.models.deletion.CASCADE, to='Module_TeamManagement.Cloud_Learning_Tools'),
        ),
        migrations.AddField(
            model_name='class',
            name='course_section',
