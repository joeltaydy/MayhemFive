...
SECRET_KEY = '9(hlqb(js3g6&-&f*ns_qro%7w6isapg1%6^43hjo3vzg$lnf#'
...
TEMPLATES_DIRS = [
    os.path.join(BASE_DIR,"Module_Account","templates"),
    os.path.join(BASE_DIR,"Module_TeamManagement","templates"),
]
